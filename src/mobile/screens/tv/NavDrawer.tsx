...
// Les listes de filtres vivent dans `filters.ts` : le script de build en a
// besoin pour pré-calculer l'appartenance aux rangées, et il ne peut pas lire
                    ...
                    >
                        ...
                        <nav className={styles.navScroll}>
                            <div className={styles.navGroup}>
                                ...
                                <a className={styles.navRow} href={MAIL_RECETTE}>
