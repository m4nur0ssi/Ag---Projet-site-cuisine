 ...
 * Dernière mise à jour: 08/04/2026 19:14:43
 * Total: 187 recettes
 */
export const exportSyncId = "1775668483069";
export const mockRecipes: Recipe[] = [
    {
        "id": "5003",
        "title": "Salade de Tortellini Croustillants à l'Airfryer",
        "description": "Fini les salades natures et sans saveur ! Essayez cette salade fraîche et gourmande avec des tortellini croustillants préparés à l'airfryer, agrémentée de légumes frais et d'une sauce onctueuse.",
        "image": "/api/image-proxy?url=http%3A%2F%2F109.221.250.122%2Fwordpress%2Fwp-content%2Fuploads%2F2026%2F04%2Frecipe_1775668322978.jpg&v=1775668349000",
        "category": "entrees",
        "difficulty": "moyen",
        "prepTime": 15,
        "cookTime": 30,
        ...
        "steps": [
            "Faire cuire les tortellini dans l'eau pendant 1 à 2 minutes.",
            "Égoutter les tortellini. Les placer dans l'airfryer avec le fromage râpé, le parmesan, la mozza et un filet d'huile d'olive.",
            "Faire dorer les tortellini et les fromages dans l'airfryer pendant 10 minutes à 180°C pour qu'ils soient bien croustillants.",
            "Pendant ce temps, préparer la sauce en mélangeant le fromage blanc, l'huile d'olive, le sel, le poivre et le vinaigre.",
    ...
    },
    {
        ...
        "image": "/api/image-proxy?url=http%3A%2F%2F109.221.250.122%2Fwordpress%2Fwp-content%2Fuploads%2F2026%2F04%2Frecipe_1775668322042.jpg&v=1775668349000",
        "category": "entrees",
        "difficulty": "moyen",
        "prepTime": 15,
        "cookTime": 30,
    ...
    },
    {
        ...
        "steps": [
            "Mélanger le beurre et le sucre jusqu'à obtenir une consistance crémeuse, puis incorporer l'œuf.",
            "Ajouter la farine et pétrir pour former une pâte. Incorporer les pépites de chocolat.",
            "Diviser la pâte en deux. Presser la première moitié dans un moule à charnière d'environ 18 cm pour former le fond, en remontant légèrement les bords.",
            "Étaler le Nutella sur la pâte, en veillant à ne pas aller jusqu'au bord pour éviter les débordements.",
            "Déposer le reste de la pâte sur le dessus, en l'aplatissant ou en la « recouvrant » légèrement.",
